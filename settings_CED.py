...
class JonesFaithfulTransformation_CED:
    ...
    def from_transformation_string(cls, transformation_string="a,b,c;0,0,0"):
        ...
        Returns:
            JonesFaithfulTransformation_CED
        """
        P, p = JonesFaithfulTransformation_CED.parse_transformation_string(transformation_string)
        return cls(P, p)
    ...
    @property
    def inverse(self) -> JonesFaithfulTransformation_CED:
        """:return: JonesFaithfulTransformation_CED"""
        Q = np.linalg.inv(self.P)
        return JonesFaithfulTransformation_CED(Q, -np.matmul(Q, self.p))
    ...
    def __str__(self):
        return str(JonesFaithfulTransformation_CED.transformation_string)

    def __repr__(self):
        return f"JonesFaithfulTransformation_CED with P:\n{self.P}\nand p:\n{self.p}"
